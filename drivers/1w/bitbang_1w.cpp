...
int bitbang_1w::reset() const
{
	struct bitbang_1w_softc *chip = this->dev_softc;
	int pin = chip->pin;
...
static int bitbang_1w_write(bitbang_1w *master, uint8_t data)
{
	struct bitbang_1w_softc *chip = master->dev_softc;
	int pin = chip->pin;
	int i;
	struct lock l;
...
static int bitbang_1w_read(bitbang_1w *master)
{
	struct bitbang_1w_softc *chip = master->dev_softc;
	int pin = chip->pin;
	uint8_t data = 0;
...
static int bitbang_1w_triplet(bitbang_1w *master, int dir)
{
	struct bitbang_1w_softc *chip = master->dev_softc;
	int pin = chip->pin;
	struct lock l;
